...
class _HallState extends State<Hall> {
  ...
  String doorStatusText = 'Door Status';
  ...
  void updateDoorStatusText(int receivedvalue) {
    setState(() {
      if (receivedvalue == 0) {
        doorStatusText = 'Door Closed';
      } else if (receivedvalue == 1) {
        doorStatusText = 'Door Opened';
      } else {
        doorStatusText = 'Unknown Status';
      }
    });
  }
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            primary: buttonClickedMap['Door Status']! ? Colors.lightBlue: Colors.white10,
                          ),
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
